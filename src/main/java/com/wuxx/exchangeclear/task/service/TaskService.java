...
public class TaskService {
    ...
    public TaskGenerateResponse generate(String taskNo) {
        SettleFile file = fileGenerateWorker.generateSync(taskNo);
        return toGenerateResponse(file);
    }
    ...
    private TaskGenerateResponse toGenerateResponse(SettleFile file) {
        return new TaskGenerateResponse(file.getTaskNo(), file.getFileNo(), file.getFileName(), file.getFileSize(), file.getFileMd5());
    }
